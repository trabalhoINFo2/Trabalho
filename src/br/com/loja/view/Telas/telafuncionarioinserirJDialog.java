 ...
 * @author hianf
 */
public class telafuncionarioinserirJDialog extends javax.swing.JDialog {

    private Funcionario funcionarioinserido = null;
    
    public Funcionario getFuncionarioinserido(){
        return this.funcionarioinserido;
    }
     ...
     */
    public telafuncionarioinserirJDialog( Frame owner) {
        super (owner , true);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("UF :");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 230, 40, 10));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telafuncionarioinserirJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telafuncionarioinserirJDialog(null).setVisible(true);
            }
        });
    }
